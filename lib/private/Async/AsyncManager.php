...
//	}
	...
	public function forkSession(string $session): void {
		if (\OC::$CLI) {
	...
	private function forkSessionLoopback(string $session): void {
		...
		try {
			...
			// TODO: throw Exception and manage it ?
...
//			echo '? ' . gettype($param) . "\n";
	...
	private function linkToLoopbackEndpoint(): string {
		return 'https://nc32.local' . $this->urlGenerator->linkToRoute('core.AsyncProcess.processFork');
	}
